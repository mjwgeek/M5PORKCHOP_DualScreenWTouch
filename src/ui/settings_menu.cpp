...
void SettingsMenu::handleInput() {
    ...
    bool up = (M5Cardputer.Keyboard.isKeyPressed(';') || extTouchConsume(ExtTouchNav::UP));
    bool down = (M5Cardputer.Keyboard.isKeyPressed('.') || extTouchConsume(ExtTouchNav::DOWN));
    bool back = (M5Cardputer.Keyboard.isKeyPressed(KEY_BACKSPACE) || extTouchConsume(ExtTouchNav::BACK));
