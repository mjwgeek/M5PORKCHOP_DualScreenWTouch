...
void SwineStats::handleInput() {
    ...
    if ((M5Cardputer.Keyboard.isKeyPressed(',') || extTouchConsume(ExtTouchNav::LEFT))) {
    ...
    if ((M5Cardputer.Keyboard.isKeyPressed('/') || extTouchConsume(ExtTouchNav::RIGHT))) {
    ...
    if ((M5Cardputer.Keyboard.isKeyPressed(KEY_ENTER) || extTouchConsume(ExtTouchNav::SELECT)) && currentTab == StatsTab::STATS) {
